...
var accordion = function accordion(titleSelector) {
  var btns = document.querySelectorAll(titleSelector); //   blocks = document.querySelectorAll(blockSelector);
  ...
  var collapseAllBtns = function collapseAllBtns() {
...
var burger = function burger(menuSelector, burgerSelector) {
  ...
  burgerElem.addEventListener('click', function () {
    if (menuElem.style.display == 'none' && window.screen.availWidth < 991) {
...
var drop = function drop() {
  // The events od drag and drop
  // drag *
  // dragend *
  // dragenter - объект над dropArea
  // dragexit *
  // dragleave - объект за пределами dropArea
  // dragover - объект в пределах dropArea (срабатывает каждые несколько милисек)
  // dragstart *
  // drop - объект упал в dropArea
  // * срабатывают на элементе который мы перетаскиваем. 
  // Это для элементов в DOM дереве, не для файловой системы
...
var filter = function filter() {
  ...
  var typeFilter = function typeFilter(markedClass, markedData) {
  ...
  menu.addEventListener('click', function (e) {
    ...
    if (target && target.tagName == "LI") {
      ...
      var selecteClass = target.classList[0];
      var noElement;
